        ...
        <div class="score-board">
            ...
            {option:FeedbackCompanyReviewsWidget.reviews.score}
                <div itemscope itemtype="http://data-vocabulary.org/Review-aggregate">
                    <a target="_blank"
                       title="{$SITE_TITLE} {$lblScoreBoardTitle|sprintf:{$FeedbackCompanyReviewsWidget.reviews.noReviews}:{$FeedbackCompanyReviewsWidget.reviews.score}:{$FeedbackCompanyReviewsWidget.reviews.scoremax}}"
                       href="{$FeedbackCompanyReviewsWidget.url}" class="clearfix">
                        <div>
                            <h2>
                        ...
                        {option:FeedbackCompanyReviewsWidget.best}
                            <div class="best-review right">
                                <blockquote
                                        title="{$FeedbackCompanyReviewsWidget.best.text}">{$FeedbackCompanyReviewsWidget.best.text|truncate:80}</blockquote>
                            </div>
                        {/option:FeedbackCompanyReviewsWidget.best}
                        ...
                        <div class="left">
                            ...
                            <span class="logo"><img height="33" width="200" alt="{$lblFeedbackCompanyLogo|ucfirst}"
                                                    src="../src/Frontend/Modules/FeedbackCompanyReviews/Layout/Images/feedback_company_logo.jpg"/></span>
